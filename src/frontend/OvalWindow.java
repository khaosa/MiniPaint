...
public class OvalWindow extends javax.swing.JFrame implements Node {
    ...
    private void initComponents() {
        ...
        HRadiusField = new javax.swing.JTextField();
        VRadiusField = new javax.swing.JTextField();
        ...
        CircleButton.setText("Create Oval");
        ...
        jLabel3.setText("Horiziontal radius");
        ...
        jLabel4.setText("Vartical radius");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(HRadiusField, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(VRadiusField, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addContainerGap())))
        );
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(HRadiusField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(VRadiusField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void CircleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CircleButtonActionPerformed
        ...
        else if (HRadiusField.getText().equals(""))
            HRadiusField.setText("Add data here");
        else if (VRadiusField.getText().equals(""))
            VRadiusField.setText("Add data here");
        else {
            try {
                int x = Integer.parseInt(XField.getText());
                int y = Integer.parseInt(YField.getText());
                int Hr = Integer.parseInt(HRadiusField.getText());
                int Hv = Integer.parseInt(VRadiusField.getText());

                if (Hr < 0){ 
                    HRadiusField.setText("Enter a positive numerical value.");}
                   else if (Hv < 0) {
                        VRadiusField.setText("Enter a positive numerical value.");
                    } else {
                        backend.Oval R = new backend.Oval(new Point(x, y), Hr, Hv);
                        R.setColor(bordercolor);
                        R.setFillColor(fillcolor);
                        R.setHorizontalDiameter(R.getHorizontalRadius()*2);
                        R.setVerticalDiameter(R.getVerticalRadius()*2);
                        parent.getDrawingArea().addShape(R);
                        parent.getDrawingArea().refresh(this.getGraphics());
                        parent.getChooseShapeComboBox().addItem("Oval" + parent.getDrawingArea().C);
                ...
                } else if (!parent.isInteger(HRadiusField.getText())) {
                    HRadiusField.setText("Not a numeric value.");

                } else if (!parent.isInteger(VRadiusField.getText())) {
                    VRadiusField.setText("Not a numeric value.");
                }
            }
    ...
    private javax.swing.JTextField HRadiusField;
    private javax.swing.JTextField VRadiusField;
